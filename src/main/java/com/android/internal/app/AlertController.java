...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(18219031, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, DialogInterface di, Window window) {
        ...
        this.mListLayout = a.getResourceId(12, 17367250);
    ...
    private void setupDecor() {
        ...
        final View parent = this.mWindow.findViewById(16909038);
        if (parent != null && decor != null) {
            decor.setOnApplyWindowInsetsListener(new OnApplyWindowInsetsListener() {
                public WindowInsets onApplyWindowInsets(View view, WindowInsets insets) {
                    if (insets.isRound()) {
                        int roundOffset = AlertController.this.mContext.getResources().getDimensionPixelOffset(17104955);
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(16909038);
        View defaultTopPanel = parentPanel.findViewById(16909039);
        View defaultContentPanel = parentPanel.findViewById(16909046);
        View defaultButtonPanel = parentPanel.findViewById(16909043);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(16909048);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(16909039);
        View customContentPanel = customPanel.findViewById(16909046);
        View customButtonPanel = customPanel.findViewById(16909043);
        ...
        if (!hasButtonPanel) {
            if (contentPanel != null) {
                View spacer = contentPanel.findViewById(16909052);
                if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (this.mMessage == null && this.mListView == null && !hasCustomPanel) {
                divider = topPanel.findViewById(16909050);
            } else {
                divider = topPanel.findViewById(16909042);
            }
            if (divider != null) {
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(16909040).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(16909041);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (ScrollView) contentPanel.findViewById(16909047);
    ...
    private void centerButton(Button button) {
        ...
        View rightSpacer = this.mWindow.findViewById(16909045);
        if (rightSpacer != null) {
    ...
    private void setBackground(TypedArray a, View topPanel, View contentPanel, View customPanel, View buttonPanel, boolean hasTitle, boolean hasCustomView, boolean hasButtons) {
        ...
        if (a.getBoolean(18, true)) {
            ...
            fullBright = 17302860;
            topBright = 17302874;
            centerBright = 17302857;
            bottomBright = 17302854;
            bottomMedium = 17302856;
        }
