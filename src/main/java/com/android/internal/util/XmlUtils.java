...
import com.android.common.speech.LoggingEvents.VoiceSearch;
...
public class XmlUtils {
    ...
    public static final void writeIntArrayXml(int[] val, String name, XmlSerializer out) throws XmlPullParserException, IOException {
        ...
        for (int num : val) {
            ...
            out.attribute(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE, Integer.toString(num));
    ...
    public static final void writeLongArrayXml(long[] val, String name, XmlSerializer out) throws XmlPullParserException, IOException {
        ...
        for (long l : val) {
            out.startTag(null, "item");
            out.attribute(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE, Long.toString(l));
            out.endTag(null, "item");
        }
    ...
    public static final void writeDoubleArrayXml(double[] val, String name, XmlSerializer out) throws XmlPullParserException, IOException {
        ...
        for (double d : val) {
            out.startTag(null, "item");
            out.attribute(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE, Double.toString(d));
            out.endTag(null, "item");
        }
    ...
    public static final void writeStringArrayXml(String[] val, String name, XmlSerializer out) throws XmlPullParserException, IOException {
        ...
        for (String attribute : val) {
            out.startTag(null, "item");
            out.attribute(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE, attribute);
            out.endTag(null, "item");
        }
    ...
    public static final void writeBooleanArrayXml(boolean[] val, String name, XmlSerializer out) throws XmlPullParserException, IOException {
        ...
        for (boolean bool : val) {
            out.startTag(null, "item");
            out.attribute(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE, Boolean.toString(bool));
            out.endTag(null, "item");
        }
    ...
    private static final void writeValueXml(Object v, String name, XmlSerializer out, WriteMapCallback callback) throws XmlPullParserException, IOException {
        if (v == null) {
            ...
            out.attribute(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE, v.toString());
            ...
            do {
                if (eventType == 2) {
                    if (parser.getName().equals("item")) {
                        try {
                            array[i] = Integer.parseInt(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE));
        ...
        try {
            ...
            do {
                if (eventType == 2) {
                    if (parser.getName().equals("item")) {
                        try {
                            array[i] = Long.parseLong(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE));
                        } catch (NullPointerException e) {
                            throw new XmlPullParserException("Need value attribute in item");
                        } catch (NumberFormatException e2) {
                            throw new XmlPullParserException("Not a number in value attribute in item");
        ...
        try {
            ...
            do {
                if (eventType == 2) {
                    if (parser.getName().equals("item")) {
                        try {
                            array[i] = Double.parseDouble(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE));
                        } catch (NullPointerException e) {
                            throw new XmlPullParserException("Need value attribute in item");
                        } catch (NumberFormatException e2) {
                            throw new XmlPullParserException("Not a number in value attribute in item");
        ...
        try {
            ...
            do {
                if (eventType == 2) {
                    if (parser.getName().equals("item")) {
                        try {
                            array[i] = parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE);
                        } catch (NullPointerException e) {
                            throw new XmlPullParserException("Need value attribute in item");
                        } catch (NumberFormatException e2) {
                            throw new XmlPullParserException("Not a number in value attribute in item");
        ...
        try {
            ...
            do {
                if (eventType == 2) {
                    if (parser.getName().equals("item")) {
                        try {
                            array[i] = Boolean.valueOf(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE)).booleanValue();
                        } catch (NullPointerException e) {
                            throw new XmlPullParserException("Need value attribute in item");
                        } catch (NumberFormatException e2) {
                            throw new XmlPullParserException("Not a number in value attribute in item");
        ...
        if (tagName.equals("null")) {
            ...
            if (obj == null) {
                if (tagName.equals("int-array")) {
                    ...
                    parser.next();
                    obj = arrayMap ? readThisArrayMapXml(parser, "map", name, callback) : readThisMapXml(parser, "map", name, callback);
                    name[0] = valueName;
                    return obj;
    ...
    private static final Object readThisPrimitiveValueXml(XmlPullParser parser, String tagName) throws XmlPullParserException, IOException {
        try {
            if (tagName.equals("int")) {
                return Integer.valueOf(Integer.parseInt(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE)));
            }
            if (tagName.equals("long")) {
                return Long.valueOf(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE));
            }
            if (tagName.equals("float")) {
                return new Float(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE));
            }
            if (tagName.equals("double")) {
                return new Double(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE));
            }
            if (tagName.equals("boolean")) {
                return Boolean.valueOf(parser.getAttributeValue(null, VoiceSearch.EXTRA_QUERY_UPDATED_VALUE));
            }
            return null;
        } catch (NullPointerException e) {
