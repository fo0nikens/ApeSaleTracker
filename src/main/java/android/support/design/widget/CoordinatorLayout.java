...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Not initialized variable reg: 0, insn: 0x0005: IF  (r0 ?[int, OBJECT, ARRAY, boolean, byte, short, char]) == (0 ?[int, OBJECT, ARRAY, boolean, byte, short, char])  -> B:7:0x0036, block:B:1:0x0005, method: android.support.design.widget.CoordinatorLayout.<clinit>():void
...
*/
        /*
        r2 = 0;
        r1 = android.support.design.widget.CoordinatorLayout.class;
    ...
    L_0x0011:
        r1 = new android.support.design.widget.CoordinatorLayout$ViewElevationComparator;
        r1.<init>();
        TOP_SORTED_CHILDREN_COMPARATOR = r1;
        r1 = new android.support.design.widget.CoordinatorLayoutInsetsHelperLollipop;
        r1.<init>();
        INSETS_HELPER = r1;
    L_0x001f:
        r1 = 2;
        ...
        r1[r2] = r3;
        r2 = 1;
        r3 = android.util.AttributeSet.class;
        r1[r2] = r3;
    ...
    void getDesiredAnchoredChildRect(View child, int layoutDirection, Rect anchorRect, Rect out) {
        ...
        int vgrav = absGravity & AbsWrapper.CMD_ACTIVATE;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & AbsWrapper.CMD_ACTIVATE;
