...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    public static abstract class Callback {
        ...
        private static final ItemTouchUIUtil sUICallback = null;
        private int mCachedMaxScrollSpeed;

        static {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.support.v7.widget.helper.ItemTouchHelper.Callback.<clinit>():void
...
*/
            ...
            r0.<init>();
            sDragScrollInterpolator = r0;
            r0 = new android.support.v7.widget.helper.ItemTouchHelper$Callback$2;
            r0.<init>();
            sDragViewScrollCapInterpolator = r0;
            r0 = android.os.Build.VERSION.SDK_INT;
            r1 = 21;
            if (r0 < r1) goto L_0x001c;
        L_0x0014:
            r0 = new android.support.v7.widget.helper.ItemTouchUIUtilImpl$Lollipop;
            r0.<init>();
            sUICallback = r0;
        L_0x001c:
            r0 = android.os.Build.VERSION.SDK_INT;
        ...
        L_0x0022:
            r0 = new android.support.v7.widget.helper.ItemTouchUIUtilImpl$Honeycomb;
            r0.<init>();
            sUICallback = r0;
            goto L_0x001b;
        L_0x002a:
            r0 = new android.support.v7.widget.helper.ItemTouchUIUtilImpl$Gingerbread;
            r0.<init>();
            sUICallback = r0;
            goto L_0x001b;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.helper.ItemTouchHelper.Callback.<clinit>():void");
        }
