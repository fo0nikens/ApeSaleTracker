...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == 1) {
                int majorGravity = this.mGravity & AbsWrapper.CMD_ACTIVATE;
                if (majorGravity != 48) {
                    switch (majorGravity) {
                        case 16:
            ...
            if (child == null) {
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i2 & AbsWrapper.CMD_ACTIVATE) >> 4) & -2) >> 1;
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline != -1) {
                            ...
                            index = (((i2 & AbsWrapper.CMD_ACTIVATE) >> 4) & -2) >> 1;
                            maxAscent[index] = Math.max(maxAscent[index], childBaseline);
                            maxDescent[index] = Math.max(maxDescent[index], childHeight - childBaseline);
                        }
                    }
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        switch (this.mGravity & AbsWrapper.CMD_ACTIVATE) {
            case 16:
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & AbsWrapper.CMD_ACTIVATE;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & AbsWrapper.CMD_ACTIVATE) {
                    case 16:
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & AbsWrapper.CMD_ACTIVATE;
        if ((this.mGravity & AbsWrapper.CMD_ACTIVATE) != gravity) {
