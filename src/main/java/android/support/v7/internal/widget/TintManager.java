...
*/
    ...
    L_0x000c:
        ...
        r0.<init>();
        INSTANCE_CACHE = r0;
        r0 = new android.support.v7.internal.widget.TintManager$ColorFilterLruCache;
        r3 = 6;
        r0.<init>(r3);
        COLOR_FILTER_CACHE = r0;
        r0 = new int[r6];
        r3 = android.support.v7.appcompat.R.drawable.abc_textfield_search_default_mtrl_alpha;
        r0[r2] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_textfield_default_mtrl_alpha;
        r0[r1] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_ab_share_pack_mtrl_alpha;
        r0[r5] = r3;
        COLORFILTER_TINT_COLOR_CONTROL_NORMAL = r0;
        r0 = 12;
        r0 = new int[r0];
        r3 = android.support.v7.appcompat.R.drawable.abc_ic_ab_back_mtrl_am_alpha;
        r0[r2] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_ic_go_search_api_mtrl_alpha;
        r0[r1] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_ic_search_api_mtrl_alpha;
        r0[r5] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_ic_commit_search_api_mtrl_alpha;
        r0[r6] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_ic_clear_mtrl_alpha;
        r0[r7] = r3;
        r3 = 5;
        r4 = android.support.v7.appcompat.R.drawable.abc_ic_menu_share_mtrl_alpha;
        r0[r3] = r4;
        r3 = 6;
        r4 = android.support.v7.appcompat.R.drawable.abc_ic_menu_copy_mtrl_am_alpha;
        r0[r3] = r4;
        r3 = 7;
        r4 = android.support.v7.appcompat.R.drawable.abc_ic_menu_cut_mtrl_alpha;
        r0[r3] = r4;
        r3 = 8;
        r4 = android.support.v7.appcompat.R.drawable.abc_ic_menu_selectall_mtrl_alpha;
        r0[r3] = r4;
        r3 = 9;
        r4 = android.support.v7.appcompat.R.drawable.abc_ic_menu_paste_mtrl_am_alpha;
        r0[r3] = r4;
        r3 = 10;
        r4 = android.support.v7.appcompat.R.drawable.abc_ic_menu_moreoverflow_mtrl_alpha;
        r0[r3] = r4;
        r3 = 11;
        r4 = android.support.v7.appcompat.R.drawable.abc_ic_voice_search_api_mtrl_alpha;
        r0[r3] = r4;
        TINT_COLOR_CONTROL_NORMAL = r0;
        r0 = new int[r7];
        r3 = android.support.v7.appcompat.R.drawable.abc_textfield_activated_mtrl_alpha;
        r0[r2] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_textfield_search_activated_mtrl_alpha;
        r0[r1] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_cab_background_top_mtrl_alpha;
        r0[r5] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_text_cursor_material;
        r0[r6] = r3;
        COLORFILTER_COLOR_CONTROL_ACTIVATED = r0;
        r0 = new int[r6];
        r3 = android.support.v7.appcompat.R.drawable.abc_popup_background_mtrl_mult;
        r0[r2] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_cab_background_internal_bg;
        r0[r1] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_menu_hardkey_panel_mtrl_mult;
        r0[r5] = r3;
        COLORFILTER_COLOR_BACKGROUND_MULTIPLY = r0;
        r0 = 10;
        r0 = new int[r0];
        r3 = android.support.v7.appcompat.R.drawable.abc_edit_text_material;
        r0[r2] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_tab_indicator_material;
        r0[r1] = r3;
        r3 = android.support.v7.appcompat.R.drawable.abc_textfield_search_material;
        r0[r5] = r3;
        ...
        r0[r7] = r3;
        r3 = 5;
        r4 = android.support.v7.appcompat.R.drawable.abc_ratingbar_full_material;
        r0[r3] = r4;
        r3 = 6;
        r4 = android.support.v7.appcompat.R.drawable.abc_switch_track_mtrl_alpha;
        r0[r3] = r4;
        r3 = 7;
        r4 = android.support.v7.appcompat.R.drawable.abc_switch_thumb_material;
        r0[r3] = r4;
        r3 = 8;
        r4 = android.support.v7.appcompat.R.drawable.abc_btn_default_mtrl_shape;
        r0[r3] = r4;
        r3 = 9;
        r4 = android.support.v7.appcompat.R.drawable.abc_btn_borderless_material;
        r0[r3] = r4;
        TINT_COLOR_CONTROL_STATE_LIST = r0;
        r0 = new int[r5];
        r3 = android.support.v7.appcompat.R.drawable.abc_btn_check_material;
        r0[r2] = r3;
        r2 = android.support.v7.appcompat.R.drawable.abc_btn_radio_material;
        r0[r1] = r2;
        TINT_CHECKABLE_BUTTON_LIST = r0;
    L_0x00d8:
        r0 = r2;
        goto L_0x000c;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.internal.widget.TintManager.<clinit>():void");
    }
