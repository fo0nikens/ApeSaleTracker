...
*/
        /*
        r1 = android.widget.PopupWindow.class;	 Catch:{ NoSuchFieldException -> 0x000d }
        r2 = "mOverlapAnchor";	 Catch:{ NoSuchFieldException -> 0x000d }
        sOverlapAnchorField = r1;	 Catch:{ NoSuchFieldException -> 0x000d }
        r1 = sOverlapAnchorField;	 Catch:{ NoSuchFieldException -> 0x000d }
        r2 = 1;	 Catch:{ NoSuchFieldException -> 0x000d }
    L_0x000d:
        r0 = move-exception;
