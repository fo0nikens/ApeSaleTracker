...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static {
        ...
        str = METADATA_KEY_ARTIST;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DURATION;
        valueOf = Integer.valueOf(0);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_ALBUM;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_AUTHOR;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_WRITER;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_COMPOSER;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_COMPILATION;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DATE;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_YEAR;
        valueOf = Integer.valueOf(0);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_GENRE;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_TRACK_NUMBER;
        valueOf = Integer.valueOf(0);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_NUM_TRACKS;
        valueOf = Integer.valueOf(0);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DISC_NUMBER;
        valueOf = Integer.valueOf(0);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_ALBUM_ARTIST;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_ART;
        valueOf = Integer.valueOf(2);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_ART_URI;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_ALBUM_ART;
        valueOf = Integer.valueOf(2);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_ALBUM_ART_URI;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_USER_RATING;
        valueOf = Integer.valueOf(3);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_RATING;
        valueOf = Integer.valueOf(3);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DISPLAY_TITLE;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DISPLAY_SUBTITLE;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DISPLAY_DESCRIPTION;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DISPLAY_ICON;
        valueOf = Integer.valueOf(2);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_DISPLAY_ICON_URI;
        valueOf = Integer.valueOf(1);
        arrayMap = METADATA_KEYS_TYPE;
        str = METADATA_KEY_MEDIA_ID;
        valueOf = Integer.valueOf(1);
    }
