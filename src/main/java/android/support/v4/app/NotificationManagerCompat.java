...
*/
        ...
        r0.<init>();
        sEnabledNotificationListenersLock = r0;
        r0 = new java.util.HashSet;
        r0.<init>();
        sEnabledNotificationListenerPackages = r0;
        r0 = new java.lang.Object;
        r0.<init>();
        sLock = r0;
    ...
    L_0x001b:
        r0 = new android.support.v4.app.NotificationManagerCompat$ImplIceCreamSandwich;
        r0.<init>();
        IMPL = r0;
    L_0x0022:
        r0 = IMPL;
        r0 = r0.getSideChannelBindFlags();
        SIDE_CHANNEL_BIND_FLAGS = r0;
    L_0x002b:
        r0 = android.os.Build.VERSION.SDK_INT;
        r1 = 5;
        if (r0 < r1) goto L_0x0038;
    L_0x0030:
        r0 = new android.support.v4.app.NotificationManagerCompat$ImplEclair;
        r0.<init>();
        IMPL = r0;
        goto L_0x0022;
    L_0x0038:
        r0 = new android.support.v4.app.NotificationManagerCompat$ImplBase;
        r0.<init>();
        IMPL = r0;
        goto L_0x0022;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.app.NotificationManagerCompat.<clinit>():void");
    }
