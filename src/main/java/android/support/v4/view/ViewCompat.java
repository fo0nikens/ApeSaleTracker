...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.support.v4.view.ViewCompat.<clinit>():void
...
*/
    ...
    L_0x0006:
        r1 = new android.support.v4.view.ViewCompat$MarshmallowViewCompatImpl;
        r1.<init>();
        IMPL = r1;
    L_0x000e:
        r1 = 21;
    ...
    L_0x0012:
        r1 = new android.support.v4.view.ViewCompat$LollipopViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
    L_0x001a:
        ...
        r1 = new android.support.v4.view.ViewCompat$KitKatViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = 17;
        if (r0 < r1) goto L_0x0032;
        r1 = new android.support.v4.view.ViewCompat$JbMr1ViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = 16;
        if (r0 < r1) goto L_0x003e;
        r1 = new android.support.v4.view.ViewCompat$JBViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = 15;
        if (r0 < r1) goto L_0x004a;
        r1 = new android.support.v4.view.ViewCompat$ICSMr1ViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = 14;
        if (r0 < r1) goto L_0x0056;
        r1 = new android.support.v4.view.ViewCompat$ICSViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = 11;
        if (r0 < r1) goto L_0x0062;
        r1 = new android.support.v4.view.ViewCompat$HCViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = 9;
        if (r0 < r1) goto L_0x006e;
        r1 = new android.support.v4.view.ViewCompat$GBViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = 7;
        if (r0 < r1) goto L_0x0079;
        r1 = new android.support.v4.view.ViewCompat$EclairMr1ViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        r1 = new android.support.v4.view.ViewCompat$BaseViewCompatImpl;
        r1.<init>();
        IMPL = r1;
        goto L_0x000d;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.ViewCompat.<clinit>():void");
    }
